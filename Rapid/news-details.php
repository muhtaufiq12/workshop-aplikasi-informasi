...
<head>
  <meta charset="utf-8">
  <title>Kelurahan Karah | Berita</title>
...
<?php
$pid=intval($_GET['nid']);
 $query=mysqli_query($con,"select tblposts.PostTitle as posttitle,tblposts.PostImage,tblposts.Category as category,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts where tblposts.id='$pid'");
