...
<input type="text" class="form-control" id="pagetitle" name="pagetitle" value="Sambutan Lurah Kelurahan Karah"  required>
</div>
...
<textarea class="summernote" name="pagedescription"  required>Assalamualaikum Wr. Wb. <br> Salam sejahtera bagi kita semua, Puji syukur kehadirat Allah SWT atas segala ridhonya, dalam rangka mempublikasikan informasi dan dokumentasi 
                ...
                ini diharapkan bisa menjadi media informasi dan publikasi untuk memenuhi kebutuhan informasi masyarakat. Portal ini
                 ...
                 sekitarnya. <br> Wassalamualaikum Wr. Wb.</textarea>
</div>
</div>
</div>
