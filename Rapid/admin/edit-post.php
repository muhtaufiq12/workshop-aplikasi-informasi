...
$query=mysqli_query($con,"update tblposts set PostTitle='$posttitle',Category='$category',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select tblposts.id as postid,tblposts.PostImage,tblposts.PostTitle as title,tblposts.PostDetails,tblposts.Category as category from tblposts where tblposts.id='$postid' and tblposts.Is_Active=1 ");
